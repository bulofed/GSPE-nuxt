<template>
  <header class="flex justify-between w-full px-16 py-2 border-b border-slate-900/10 dark:border-slate-300/10">
    <NuxtLink to="/">
      <div class="flex justify-center bg-white dark:bg-slate-100 rounded-full p-2 size-12">
        <img
